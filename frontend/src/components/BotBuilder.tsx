...
import {
  ...
  Download, Zap, Info, FileUp
} from 'lucide-react';
import { BOT_REGISTRY } from '../bot-modules';
...
export const BotBuilder = () => {
  ...
  // Инициализируем реестр внутри компонента через useMemo
  const ALL_MODULES = useMemo(() => {
    return Object.values(BOT_REGISTRY).map((m: any) => ({
      id: m.id || 'unknown',
  ...
  }, [searchTerm, activeCat, ALL_MODULES]);
